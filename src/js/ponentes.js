    ...
    if(ponentesInput) {
        ...
        if(ponenteHidden.value) {
            (async () => {
                ...
                ponentesInput.value = ponenteDOM.textContent;
            })();
        }
        ...
        function seleccionarPonente(e) {
            ...
            const ponentePrecvio = document.querySelector('.listado-ponentes__ponente--seleccionado');
            if(ponentePrecvio) {
                ponentePrecvio.classList.remove('listado-ponentes__ponente--seleccionado');
            }
