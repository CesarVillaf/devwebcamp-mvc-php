...
<section class="resumen">
    <div class="resumen__grid">
        <div <?php aos_animacion(); ?> data-aos-once="false" class="resumen__bloque">
    ...
    <div class="speakers__grid">
        <?php foreach($ponentes as $ponente): ?>
            <div <?php aos_animacion(); ?> class="speaker">
                <picture>
                    <source srcset="/img/speekers/<?php echo $ponente->imagen; ?>.webp" type="image/webp">
                    <source srcset="/img/speekers/<?php echo $ponente->imagen; ?>.png" type="image/png  ">
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="/img/speekers/<?php echo $ponente->imagen; ?>.png" alt="Imágen Ponente">
                </picture>
                    ...
                    <nav class="speaker-sociales">
                        ...
                        <?php if(!empty($redes->github)): ?>
                            <a class="speaker-sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?php echo $redes->github; ?>">
                                <span class="speaker-sociales__ocultar">Githup</span>
                            </a>
                        <?php endif; ?>
                    </nav>
