...
<script src="https://www.paypal.com/sdk/js?client-id=ARh1ksLj0qHt6oqXbm4gYLIUx1chstcJp2kuywqpWbeU8dpPxl5sIzCKiVET322cWCBSzJlnaRPGL6my&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory"></script>
        ...
        paypal.Buttons({
            ...
            onApprove: function(data, actions) {
                return actions.order.capture().then(function(orderData) {
                    ...
                    fetch(`${location.origin}/finalizar-registro/pagar`, {
                        method: 'POST',
                        body: datos
                    })
