<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">DevWebCamp es una conferencia para desarrolladores de todos los niveles y se lleva a cabo de forma presencial y en linea.</p>
        </div> <!-- .footer__contenido -->
        ...
        <nav class="menu-redes"> 
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://github.com/codigoconjuan">
                <span class="menu-redes__ocultar">Githup</span>
            </a>
        </nav> <!-- .menu-redes -->
    </div> <!-- .footer__grid -->
